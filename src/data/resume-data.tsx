...
export const RESUME_DATA = {
  ...
  skills: [
    "Cybersecurity: Information Security (INFOSEC), Network Security, Cloud Security, Access Control, Cryptography",
    "Threat Management: Threat Analysis & Detection, Malware Identification, Cyber Forensics",
  ],
  projects: [
    {
