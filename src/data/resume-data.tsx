...
export const RESUME_DATA = {
  ...
  skills: [
    "Cybersecurity: Access Control, Authentication, Cloud Security, Cryptography, Cyber Forensics, Cybersecurity Assessment, Data Security, Disaster Recovery Planning, Firewall Configuration, Information Assurance, Information Security (INFOSEC), Information Systems, Intrusion Detection Systems (IDS), Intrusion Prevention Systems (IPS), Malware Identification, Mobile Device Security, Network Security, NIST Cybersecurity Framework, Risk Assessment, Risk Management Framework, Security Configuration, Security Information and Event Management (SIEM), Security Policies, Threat Analysis, Threat Detection, Vulnerability Assessment",
    "Programming & Databases: Docker, PostgreSQL, Python, SQL",
    "Systems & Tools: Linux, Network Analyzer tools, Windows",
    "Communication Skills: Cross-functional Collaboration, Stakeholder Management, Technical Writing, Verbal Communication",
    "Leadership & Project Management: Organization, Planning, Teamwork, Time Management",
    "Problem Solving: Adaptability, Attention to Detail, Critical Thinking",
    "Professional Attributes: Ethical Decision Making, Continuous Learning, Cultural Awareness, Stress Management",
    "Strategic Thinking: Foresight, Scenario Analysis, Strategic Planning",
